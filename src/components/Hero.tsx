...
const BANNERS: Banner[] = [
  {
    ...
    subtitle: "Daily essentials products, get everything delivered to your doorstep in 15 minutes flat.",
    highlightText: "Quality products at affordable prices",
    colorClass: "from-green-600 to-emerald-800",
    imgUrl: "https://res.cloudinary.com/dkduejkuj/image/upload/v1782112141/d6a85625-45ca-4917-959e-4dd8697de76d.png",
  },
  {
    id: "b3",
    tagline: "🍿 WEEKEND MATCH DAY BINGE PARTY",
    title: "Snacks, Munchies & Cold Fizzy Drinks",
    subtitle: "Score amazing combo deals on premium potato chips, double-choc cookies, and chilled cold sodas for your late night streams.",
